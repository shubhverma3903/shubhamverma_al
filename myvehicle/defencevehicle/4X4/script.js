...
function calculateEquivalentAngles() {
    ...
    //unladen
    // GB to AGB
    const a7i = parseFloat(document.getElementById('angleA6').value);
    const b7i = parseFloat(document.getElementById('angleB6').value);
    const c7i = parseFloat(document.getElementById('angleC6').value);
    const d7i = parseFloat(document.getElementById('angleD6').value);
    ...
    //unladen
    // AGB to RA1
    const a71i = parseFloat(document.getElementById('angleA61').value);
    const b71i = parseFloat(document.getElementById('angleB61').value);
    const c71i = parseFloat(document.getElementById('angleC61').value);
    const d71i = parseFloat(document.getElementById('angleD61').value);
    ...
    //unladen
    // RA1 to RA2
    const a72i = parseFloat(document.getElementById('angleA62').value);
    const b72i = parseFloat(document.getElementById('angleB62').value);
    const c72i = parseFloat(document.getElementById('angleC62').value);
    const d72i = parseFloat(document.getElementById('angleD62').value);
