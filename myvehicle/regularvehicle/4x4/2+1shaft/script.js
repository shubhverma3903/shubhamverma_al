...
function calculateEquivalentAngles() {
   ...
   // Input angles (replace with actual values)
    ...
    //torsional calc FOR INTER AXLE
     ...
     const e92 = parseFloat(document.getElementById('angleG7').value);
     ...
     const e92i = parseFloat(document.getElementById('angleG7').value);
 ...
 <div class="calculator-container1">
         ...
         <h3>laden </h3>
          ...
          <div class="box">2.Equivalent angle 1(++-): ${(Math.sqrt(Math.abs(g6 * g6 + h6 * h6 - i6 * i6))).toFixed(2)}</div> 
          ...
          <div class="box">2.Equivalent angle 1(++-): ${(Math.sqrt(Math.abs(g6u * g6u + h6u * h6u - i6u * i6u))).toFixed(2)}</div> 
