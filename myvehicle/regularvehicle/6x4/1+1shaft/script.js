 ...
 function calculateEquivalentAngles() {
    ...
    //torsional calc FOR INTER AXLE
     ...
     const e92 = parseFloat(document.getElementById('angleE7').value);
     ...
     const e92i = parseFloat(document.getElementById('angleE7').value);
    ...
    document.getElementById('result').innerHTML = `
     ...
     <div class="container">
        <div class="calculator-container1">
           ...
           <div class="box" id="betaAngle"> Against Critical Speed, The Propeller Shaft is : ${(k1*h1*0.75) >= j1 ? 'Safe' : 'Unsafe'}</div><hr><hr>
           <h4>Extra part</h4>
