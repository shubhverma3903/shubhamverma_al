...
function calculateEquivalentAngles() {
   ...
   // Input angles (replace with actual values)
    ...
    //torsional calc FOR INTER AXLE
     ...
     const e92 = parseFloat(document.getElementById('angleK78').value);
     ...
     const e92i = parseFloat(document.getElementById('angleK78').value);
...
<div class="container">
  ...
  <div class="calculator-container1">
     ...
     <div id="BetaAngle5">2. Speed x Deflection Angle: ${f5.toFixed(2)}</div><hr><hr>
     <h4>Extra part</h4>
 ...
 <div class="calculator-container1">
            ...
            <div id="betaAngle73">3.Inertia Coast Excitation: ${v71.toFixed(2)} (rad/s^2), ${v71.toFixed(2) <2000 ? 'Safe' : 'Unsafe'}</div><hr> 
            </div>
            <div class="calculator-container2">
            <h3>unladen </h3>
            ...
            <div id="betaAngle73u">3.Inertia Coast Excitation: ${v71u.toFixed(2)} (rad/s^2), ${v71u.toFixed(2) <2000 ? 'Safe' : 'Unsafe'}</div><hr>
            </div>
            </div>
            <hr>
